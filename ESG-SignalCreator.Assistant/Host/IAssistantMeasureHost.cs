...
{
    /// <summary>
    /// E4406A measurement + verification host for the assistant's measure_* / verify_signal tools
    /// (#90, §8/§9). The App implements it against the connected <c>VsaInstrument</c> and the same Core
