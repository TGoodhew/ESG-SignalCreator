...
forholdet, ved at sammenligne **Newman** vs **Equal**-fasning i **resultataflæsningen** og **CCDF**-visningen.
...
**Tips / fejlfinding:**
- Prøv også **Random**-fasning — den lander normalt mellem Newman og Equal.
- Multitone er en klassisk test for forstærkerlinearitet og PAPR-håndtering; signaler med høj PAPR (Equal)
...
1. Vælg en måde at udløse et fund på, derefter **Calculate** og læs **Notifications**:
   ...
   - **DAC over-range:** brug et signal med høj PAPR (Equal-faset multitone eller uclippet AWGN) og/eller
